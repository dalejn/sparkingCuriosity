...
install.packages(c('RColorBrewer', 'igraph', 'ggplot2', 'devtools', 'magick', 'ellipsis', 'vctrs', 'assertthat', 'backports', 'animation', 'plyr', 'RcppEigen', 'tidyselect', 'polyclip', 'tweenr', 'generics', 'ggforce', 'dplyr'))
